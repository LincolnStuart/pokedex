...
import co.lincolnstuart.pokedex.persistence.task.ClearScore;
import co.lincolnstuart.pokedex.persistence.task.GetScore;
import co.lincolnstuart.pokedex.persistence.task.GetSettings;
import co.lincolnstuart.pokedex.persistence.task.UpdateSettings;
